...
% Load Packages
	...
	\input{header/hsrColors} 				% Color definitions from HSR CI
...
% Document Setup
	...
	\ohead{\Title}
	\chead{}
	\ihead{\includegraphics[height=30pt]{header/HSR_Logo_A4.jpg}}
	\ofoot{}
	\cfoot{\thepage}
	\ifoot{\Author}	
	...
	\usepackage[
		...
		linkcolor=HSRBlue,
		citecolor=HSRReed,
		filecolor=HSRLakeGreen,
		urlcolor=HSRLakeGreen,
	...
	\renewcommand{\marginpar}[1]{\leavevmode\oldmarginpar{{#1}}}