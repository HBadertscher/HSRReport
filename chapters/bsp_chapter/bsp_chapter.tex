...
\marginpar{SI Units}Any numbers and units should by typed using the siunitx package.
...
\marginpar{Index \& Glossary}All glossary entries are made in the separate file \texttt{glossary.tex}.
