...
\marginpar{Goal of this chapter}
...
\marginpar{Equations}Equations can easily be written using the \emph{equation}
...
\marginpar{Figures and Tables}Images are always inserted inside a \emph{figure}
